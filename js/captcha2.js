...
let images = [];
let imgSources = [
  "assets/textures/traffic_light_images/00.jpg",
  "assets/textures/traffic_light_images/10.jpg",
  "assets/textures/traffic_light_images/20_correct.jpg",
  "assets/textures/traffic_light_images/01_correct.jpg",
  "assets/textures/traffic_light_images/11_correct.jpg",
  "assets/textures/traffic_light_images/21_correct.jpg",
  "assets/textures/traffic_light_images/02_correct.jpg",
  "assets/textures/traffic_light_images/12_correct.jpg",
  "assets/textures/traffic_light_images/22_correct.jpg",
];
let padding = 5;
...
ctn_btn.addEventListener("click", () => {
  ...
  selectedTiles = Array(9).fill(false);
  setTimeout(() => {
    window.location.href = "captcha_truck.html";
  }, 500);
});